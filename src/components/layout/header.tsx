        ...
        <header className="fixed top-0 left-0 right-0 z-50 p-6">
            <div className="mx-auto flex max-w-5xl items-center justify-start gap-2">
                ...
                {isAuthenticated && user && (
                    <>
                        {/* Block 2: Profile */}
                        <Link href="/profile" className="glass bg-[var(--color-secondary)]/65 backdrop-blur-md border border-white/10 flex h-12 items-center gap-3 rounded-2xl px-4 shadow-lg transition-all hover:scale-[1.02]">
                            {/* Avatar */}
