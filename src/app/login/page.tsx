...
const SteamIcon = () => (
  <svg viewBox="0 0 512 512" fill="currentColor" className="h-full w-full">
    ...
    <g xmlns="http://www.w3.org/2000/svg" fill="none" stroke="#ebebeb">
      ...
      <main className="w-full max-w-4xl grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="glass-card bg-[var(--color-secondary)]/65 backdrop-blur-md border border-white/10 flex flex-col justify-center p-8 md:p-12 shadow-2xl">
          <div className="mb-6">
            ...
            <p className="text-lg text-muted leading-relaxed">
              ...
              чтобы получить доступ к вашему профилю, настроить настройки и подключиться к
              сообществу.
            </p>
          </div>
        ...
        <div className="glass-card bg-[var(--color-secondary)]/65 backdrop-blur-md border border-white/10 flex flex-col justify-center p-8 md:p-12 shadow-2xl">
          ...
          <div className="flex flex-col gap-4">
            <SocialButton provider="twitch" icon={<TwitchIcon />} />
            <SocialButton provider="discord" icon={<DiscordIcon />} />
            <SocialButton provider="steam" icon={<SteamIcon />} />
          </div>
        </div>
      </main>
    </div>
