 ...
 * Admin Badges Page
 *
 * Page for managing badges (admin only)
 */
...
import { BadgesListWidget } from '@/components/admin/badges/badges-list-widget';
		...
		<div className="min-h-screen pb-20 pt-24">
			...
			<main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-6">
				<div className="mb-6">
					...
					<p className="text-lg text-white/60">Создание и управление наградами</p>
				</div>
