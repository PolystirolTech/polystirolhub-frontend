 ...
 * Admin Quests Page
 *
 * Page for managing quests (admin only)
 */
...
import { QuestsListWidget } from '@/components/admin/quests/quests-list-widget';
		...
		<div className="min-h-screen pb-20 pt-24">
			...
			<main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-6">
				<div className="mb-6">
					...
					<p className="text-lg text-white/60">Создание и управление квестами и достижениями</p>
				</div>
