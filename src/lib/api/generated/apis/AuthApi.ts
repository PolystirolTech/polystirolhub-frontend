...
export class AuthApi extends runtime.BaseAPI {
     ...
     * Check Link Status
     */
    async checkLinkStatusApiV1AuthCheckLinkStatusUserIdGetRaw(requestParameters: CheckLinkStatusApiV1AuthCheckLinkStatusUserIdGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<LinkStatusResponse>> {
        if (requestParameters.userId === null || requestParameters.userId === undefined) {
            throw new runtime.RequiredError('userId','Required parameter requestParameters.userId was null or undefined when calling checkLinkStatusApiV1AuthCheckLinkStatusUserIdGet.');
        }
        ...
        const response = await this.request({
            path: `/api/v1/auth/check-link-status/{user_id}`.replace(`{${"user_id"}}`, encodeURIComponent(String(requestParameters.userId))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => LinkStatusResponseFromJSON(jsonValue));
    }
     ...
     * Check Link Status
     */
    async checkLinkStatusApiV1AuthCheckLinkStatusUserIdGet(requestParameters: CheckLinkStatusApiV1AuthCheckLinkStatusUserIdGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<LinkStatusResponse> {
        const response = await this.checkLinkStatusApiV1AuthCheckLinkStatusUserIdGetRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async generateLinkCodeEndpointApiV1AuthGenerateLinkCodePostRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<LinkCodeGenerateResponse>> {
        const queryParameters: any = {};
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => LinkCodeGenerateResponseFromJSON(jsonValue));
    }
     ...
     * Generate Link Code Endpoint
     */
    async generateLinkCodeEndpointApiV1AuthGenerateLinkCodePost(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<LinkCodeGenerateResponse> {
        const response = await this.generateLinkCodeEndpointApiV1AuthGenerateLinkCodePostRaw(initOverrides);
        return await response.value();
    }
     ...
     * Link Game Account
     */
    async linkGameAccountApiV1AuthLinkPostRaw(requestParameters: LinkGameAccountApiV1AuthLinkPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<LinkResponse>> {
        if (requestParameters.linkRequest === null || requestParameters.linkRequest === undefined) {
            throw new runtime.RequiredError('linkRequest','Required parameter requestParameters.linkRequest was null or undefined when calling linkGameAccountApiV1AuthLinkPost.');
        }
     ...
     * Link Game Account
     */
    async linkGameAccountApiV1AuthLinkPost(requestParameters: LinkGameAccountApiV1AuthLinkPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<LinkResponse> {
        const response = await this.linkGameAccountApiV1AuthLinkPostRaw(requestParameters, initOverrides);
        return await response.value();
    }
