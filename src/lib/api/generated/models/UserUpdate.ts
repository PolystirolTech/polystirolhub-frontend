...
import { Email1FromJSON, Email1FromJSONTyped, Email1ToJSON } from './Email1';
import type { IsActive1 } from './IsActive1';
import { IsActive1FromJSON, IsActive1FromJSONTyped, IsActive1ToJSON } from './IsActive1';
import type { IsAdmin } from './IsAdmin';
import { IsAdminFromJSON, IsAdminFromJSONTyped, IsAdminToJSON } from './IsAdmin';
...
export function UserUpdateFromJSONTyped(json: any, ignoreDiscriminator: boolean): UserUpdate {
	...
	return {
		...
		isSuperAdmin: !exists(json, 'is_super_admin')
			? undefined
