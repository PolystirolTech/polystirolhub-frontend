...
export function ServerStatusResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ServerStatusResponse {
    ...
    return {
        ...
        'playersList': !exists(json, 'players_list') ? undefined : PlayersListFromJSON(json['players_list']),
